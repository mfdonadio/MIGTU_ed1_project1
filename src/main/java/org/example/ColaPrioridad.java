...
/**
 * Esta es la ultima estructura que vimos, y la mas importante en el sentido del proyecto.
 * La idea, por lo visto en clase, es impplementar un 'Heap' sobre un 'Array".
 * Vamos a enfocar la estructura 'base' sobre un Max-Heap, y que tenga la opcion de cambiarse a Min-Heap.
 */
public class ColaPrioridad<T> {
    ...
    public ColaPrioridad(Comparator<T> comparador, int capacidadInicial){
